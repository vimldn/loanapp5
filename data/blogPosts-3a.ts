...
export const blogPosts3A: BlogPost[] = [

  // ── Post 1: Increase Tala/Branch limit ─────────────────────────────────
  {
    id: 201,
...
<table>
<thead><tr><th>Repayment Style</th><th>After 3 Cycles</th><th>After 6 Cycles</th><th>After 10 Cycles</th></tr></thead>
<tbody>
<tr><td>Always early (5+ days before due)</td><td>~KES 3,000</td><td>~KES 15,000</td><td>~KES 40,000+</td></tr>
<tr><td>On time (due date)</td><td>~KES 2,000</td><td>~KES 8,000</td><td>~KES 20,000</td></tr>
<tr><td>Occasionally late</td><td>~KES 1,200</td><td>~KES 4,000</td><td>~KES 8,000</td></tr>
</tbody>
</table>

<p>Starting amount assumed: KES 500 first loan. Percentages are indicative based on typical user experience.</p>
...
<li>Make regular M-Pesa deposits into your savings (even small amounts)</li>
</ul>

<h2>Step 4: Keep the App Installed and Engaged</h2>

<p>Uninstalling the app between loans and reinstalling when you need money is a red flag to the algorithm. <strong>Keep Tala or Branch installed</strong>, open it occasionally, and keep your profile updated. Some users report that updating their profile details (employment status, income estimate) before applying for a limit increase triggers a review.</p>
...
<table>
<thead><tr><th>Loan Cycle</th><th>Typical Tala Limit</th><th>Typical Branch Limit</th><th>Key Action</th></tr></thead>
<tbody>
<tr><td>1st loan</td><td>KES 500–2,000</td><td>KES 500–1,500</td><td>Repay 5+ days early</td></tr>
<tr><td>3rd loan</td><td>KES 2,000–5,000</td><td>KES 2,000–6,000</td><td>Increase M-Pesa activity</td></tr>
<tr><td>6th loan</td><td>KES 8,000–15,000</td><td>KES 10,000–20,000</td><td>Keep app active, zero gaps</td></tr>
<tr><td>10th loan</td><td>KES 20,000–35,000</td><td>KES 25,000–50,000</td><td>Pay off all other app loans</td></tr>
<tr><td>15th+ loan</td><td>Up to KES 50,000</td><td>Up to KES 70,000</td><td>Maintain perfect record</td></tr>
</tbody>
</table>
...
<h3>Does Branch give a higher limit than Tala?</h3>
<p>Branch's maximum is KES 70,000 vs Tala's KES 50,000 for most users. Branch also tends to increase faster for users who use their in-app credit builder and savings features.</p>`,
  },

  // ── Post 2: Longest repayment periods ──────────────────────────────────
  {
    id: 202,
...
<strong>Maximum amount:</strong> KES 50,000<br/>
<strong>Category:</strong> Fintech</p>

<p><strong>Important note:</strong> iPesa has been flagged on our <a href="/blacklist">blacklist</a> for contact shaming practices. We include it here for completeness because it does technically offer 90-day terms, but <strong>we do not recommend using it</strong>. The contact shaming risk is real and well-documented. Consider Branch or KCB M-Pesa instead for longer terms.</p>

<h2>Summary Comparison Table</h2>

<table>
<thead><tr><th>App</th><th>Max Term</th><th>Max Amount</th><th>Monthly Rate</th><th>Best For</th></tr></thead>
<tbody>
<tr><td>Branch</td><td>12 months</td><td>KES 70,000</td><td>4–24%</td><td>Fintech with longest terms</td></tr>
...
<h2>The Smart Strategy: Match Term to Purpose</h2>

<p>Before borrowing, ask yourself: what is this loan for, and when will I have money to repay it?</p>
...
<p>Not always. Longer terms reduce monthly burden but increase total interest paid. Always calculate the total repayment — not just the monthly instalment — before committing to a longer term.</p>`,
  ...
  {
    id: 203,
    slug: 'how-to-apply-hustler-fund-group-loan-kenya',
...
<p>The Hustler Fund, launched by President Ruto's government in November 2022, has two main products:</p>

<ol>
<li><strong>Personal Loan:</strong> Individual borrowing of KES 500–50,000 via *254# or the Hustler Fund app</li>
...
<h3>Individual Member Requirements</h3>
<ul>
<li>Valid Kenyan National ID</li>
<li>Active M-Pesa account on a registered Safaricom line</li>
<li>At least 3 months of M-Pesa account activity</li>
<li>No current CRB negative listing</li>
<li>Must have registered for Hustler Fund individually first (via *254# or the app)</li>
<li>At least 1 completed personal Hustler Fund loan cycle (some branches require this)</li>
</ul>

<h3>Group Requirements</h3>
<ul>
<li>Minimum group size: <strong>2 members</strong> (though 5–10 is typical for higher limits)</li>
<li>Maximum group size: <strong>20 members</strong></li>
<li>All members must individually register for Hustler Fund before the group application</li>
<li>The group must appoint a <strong>Group Administrator</strong> who leads the application</li>
<li>The group does not need to be formally registered (no certificate of registration required for small groups)</li>
</ul>

<h2>Step-by-Step Application Process</h2>

<h3>Step 1: All Members Register Individually</h3>
<p>Before forming a group, every member must register for Hustler Fund individually:</p>
<ol>
<li>Dial <strong>*254#</strong> on any Safaricom line</li>
<li>Select "Register"</li>
<li>Enter your National ID number</li>
<li>Confirm your name and accept the terms</li>
<li>You will receive an SMS confirming your Hustler Fund registration</li>
</ol>
<p>Alternatively, download the <strong>Hustler Fund app</strong> from the Google Play Store and complete registration there.</p>

<h3>Step 2: Elect a Group Administrator</h3>
<p>Choose one trusted member to be the Group Administrator. This person will:</p>
<ul>
<li>Lead the group registration process</li>
...
<ol>
<li>The Group Administrator opens the Hustler Fund app and navigates to <strong>"Group Loans"</strong> or <strong>"Biashara Loan"</strong></li>
...
<h3>Step 4: Apply for the Group Loan</h3>
<ol>
...
<table>
<thead><tr><th>Group Size</th><th>Typical First Group Loan</th><th>After 2–3 Cycles</th><th>Maximum Possible</th></tr></thead>
<tbody>
<tr><td>2–4 members</td><td>KES 2,000–10,000</td><td>KES 15,000–30,000</td><td>~KES 100,000</td></tr>
<tr><td>5–9 members</td><td>KES 10,000–25,000</td><td>KES 40,000–80,000</td><td>~KES 250,000</td></tr>
<tr><td>10–20 members</td><td>KES 20,000–50,000</td><td>KES 100,000–200,000</td><td>~KES 500,000+</td></tr>
</tbody>
</table>

<p>Limits are indicative and depend heavily on individual member histories. A group where every member has completed 5+ personal Hustler Fund loan cycles will receive a much higher initial group limit.</p>
...
<li>Fewer than 2 members accepting the group invitation</li>
</ul>

<h2>Tips for a Successful Group Application</h2>
...
<h3>What happens if one group member cannot repay?</h3>
...
<p>Under the <strong>Data Protection Act 2019</strong> and the <strong>Kenya Information and Communications Act</strong>, Kenyans have legal rights around unsolicited marketing communications:</p>

<ul>
<li>You have the <strong>right to withdraw marketing consent</strong> at any time</li>
<li>Companies must provide a <strong>free opt-out mechanism</strong> in every marketing message</li>
<li>Continuing to send marketing messages after an opt-out request is a violation of Kenyan data protection law</li>
<li>You can file a complaint with the <strong>Office of the Data Protection Commissioner (ODPC)</strong> at odpc.go.ke</li>
</ul>

<p>The ODPC has the power to investigate complaints and fine companies up to KES 5 million for data protection violations. This is your nuclear option if the simpler methods fail.</p>

<h2>App-by-App Opt-Out Methods</h2>

<h3>Tala Kenya</h3>
<ol>
<li><strong>Via the app:</strong> Open Tala → Settings → Notifications → disable Marketing SMS</li>
<li><strong>Via SMS:</strong> Text <strong>STOP</strong> to the Tala SMS sender number (check the "From" number on any Tala SMS you have received)</li>
<li><strong>Via email:</strong> Email <strong>privacy@tala.co</strong> stating you withdraw consent for marketing communications. Include your full name and registered phone number.</li>
<li><strong>Via the Tala website:</strong> Visit tala.co → Privacy → Data Deletion Request to remove your data entirely</li>
</ol>
...
<h3>KCB M-Pesa</h3>
<ol>
<li><strong>Via KCB app:</strong> Open KCB Mobile → Settings → Privacy → Marketing Preferences → Off</li>
<li><strong>Via KCB call centre:</strong> Call <strong>0711 087 000</strong> and request removal from KCB marketing lists</li>
<li><strong>Via email:</strong> Email <strong>csd@kcbgroup.com</strong> with your opt-out request</li>
</ol>

<h3>Zenka</h3>
<ol>
<li><strong>Via the app:</strong> Zenka app → Account → Settings → Communication Preferences → disable SMS</li>
<li><strong>Via email:</strong> Email <strong>support@zenka.co.ke</strong> with your opt-out request and registered phone number</li>
</ol>
...
<h3>Hustler Fund</h3>
<ol>
<li><strong>Via the app:</strong> Hustler Fund app → Settings → Notifications → toggle off Promotional Messages</li>
<li><strong>Via USSD:</strong> Dial *254# → Account Settings → Notifications</li>
<li><strong>Via the helpline:</strong> Call the Hustler Fund helpline at <strong>0800 724 252</strong> (free)</li>
</ol>

<h2>The Universal Method: Block at Safaricom Level</h2>

<p>For any unsolicited SMS from a Safaricom-connected short code, you can block it directly with Safaricom. This is more powerful than individual app opt-outs because it works at the network level.</p>
...
<h2>For Third-Party/Unknown Loan App SMS</h2>

<p>Many of the worst offenders are unlicensed loan apps or apps that bought your number from a data broker. For these:</p>
...
<li>Include: your full name, registered phone number, and the specific data you want deleted</li>
<li>The company has <strong>30 days</strong> to comply under Kenyan law</li>
...
<h3>What is the fastest way to stop all loan app SMS?</h3>
