...
<p>Missing a loan app repayment sets off a sequence of events. Knowing what is coming removes the element of fear and lets you respond rationally:</p>
...
<h2>Your Legal Rights Under Kenyan Law</h2>

<p>The CBK's <strong>Credit Provider Regulations 2022</strong> and the <strong>Data Protection Act 2019</strong> give you enforceable rights even when you default. Know these before you respond to any lender:</p>

<h3>Right 1: Protection from Harassment</h3>
<p>Loan apps and their collection agents are legally prohibited from:</p>
<ul>
<li>Calling you at unreasonable hours (before 8AM or after 9PM)</li>
<li>Using abusive, threatening, or obscene language</li>
<li>Making false statements about legal action they will take</li>
<li>Threatening you with arrest for a civil debt (you cannot be arrested for failing to repay a loan app)</li>
</ul>

<h3>Right 2: No Criminal Liability</h3>
...
<h3>Step 1: Contact the Lender Before They Call You</h3>
<p>The single most important action you can take is to contact the loan app <strong>before</strong> they escalate. Calling first signals good faith and dramatically changes how the interaction proceeds. Most loan app customer support channels:</p>
<ul>
<li><strong>Tala:</strong> In-app chat or WhatsApp at +1 (888) 880-7427</li>
<li><strong>Branch:</strong> In-app support chat or hello@branch.co</li>
<li><strong>M-Shwari:</strong> Safaricom customer care on 100 (free call)</li>
<li><strong>KCB M-Pesa:</strong> KCB customer care on 0711 087 000</li>
<li><strong>Zenka:</strong> support@zenka.co.ke or in-app chat</li>
<li><strong>Hustler Fund:</strong> 0800 724 252 (free)</li>
</ul>

<h3>Step 2: Explain Your Situation Honestly</h3>
<p>You do not need to share personal details beyond what is relevant. A simple, clear statement is enough:</p>
<blockquote>
...
<p>For most CBK-regulated apps, CRB listing triggers when:</p>
<ul>
<li>The overdue amount exceeds <strong>KES 1,000</strong></li>
<li>The loan is overdue by <strong>30 days or more</strong> (some apps list at 60 days)</li>
...
<ul>
<li>Communicating with third parties about a borrower's debt without the borrower's consent</li>
<li>Using tactics that amount to harassment, oppression, or abuse</li>
<li>Publishing or threatening to publish a borrower's debt status</li>
</ul>

<h3>3. Consumer Protection Act 2012</h3>
<p>The Act prohibits unfair commercial practices that cause material distress to consumers. Contacting an employer about an employee's consumer debt without consent constitutes an unfair commercial practice.</p>

<h2>Step 1: Document Every Incident Immediately</h2>

<p>Before you take any other action, document the contact shaming incident in detail. Good documentation is the foundation of any successful complaint.</p>
...
<p>If your contact received a WhatsApp message rather than a call, ask them to screenshot it and send it to you. Do not delete any messages.</p>

<h2>Step 2: Revoke App Permissions Immediately</h2>

<p>Even while pursuing a complaint, prevent further access to your contacts immediately:</p>

<ol>
<li>Go to your phone's <strong>Settings → Apps</strong></li>
<li>Find the offending loan app</li>
<li>Tap <strong>Permissions</strong></li>
<li>Set <strong>Contacts</strong> permission to <strong>Deny</strong></li>
<li>Also deny: Phone, SMS, and Location while you are there</li>
</ol>

<p>On most Android phones: Settings → Privacy → Permission Manager → Contacts → select the app → Deny.</p>

<p>Revoking permissions stops further reading of your contacts but does not delete contacts they have already accessed. The complaint process addresses that.</p>

<h2>Step 3: Send a Formal Cease and Desist to the Lender</h2>
...
<ul>
<li><em>Section 25 of the Data Protection Act 2019 (secondary processing of personal data)</em></li>
<li><em>CBK Credit Provider Regulations 2022 (prohibited debt collection practices)</em></li>
</ul>
<p><em>I formally demand that you immediately:</em></p>
<ol>
<li><em>Cease all contact with any third parties regarding my account</em></li>
<li><em>Delete all contact information obtained from my phone</em></li>
<li><em>Confirm in writing within 7 days that you have complied</em></li>
</ol>
<p><em>Failure to comply will result in a formal complaint to the Office of the Data Protection Commissioner (ODPC) and the Central Bank of Kenya Consumer Protection Department.</em></p>
<p><em>Your name, registered phone number, account reference</em></p>
</blockquote>

<p>Send this via email to the lender's official support address. Keep a copy of the sent email.</p>

<h2>Step 4: File a Complaint with the ODPC</h2>

<p>The Office of the Data Protection Commissioner (ODPC) is Kenya's data protection regulator. Filing a complaint is free, takes approximately 20 minutes online, and is far more effective than arguing with the lender directly.</p>

<ol>
<li>Go to <strong>odpc.go.ke</strong></li>
<li>Navigate to <strong>"File a Complaint"</strong></li>
<li>Create an account or log in</li>
<li>Select complaint type: <strong>"Unlawful processing of personal data"</strong></li>
<li>Provide:
  <ul>
  <li>Your name and contact details</li>
  <li>The name of the loan app (the data controller)</li>
  <li>Description of what happened (use your documentation from Step 1)</li>
...
<h2>Step 5: File a Complaint with the CBK</h2>

<p>For CBK-licensed lenders (which includes Tala, Branch, Zenka, M-Shwari, and KCB M-Pesa), you can also file a complaint with the Central Bank of Kenya's Consumer Protection Department.</p>

<ul>
<li><strong>Online:</strong> centralbank.go.ke → Consumer Protection → File a Complaint</li>
<li><strong>Email:</strong> ccpd@centralbank.go.ke</li>
<li><strong>Phone:</strong> 020 286 0000</li>
<li><strong>Physical:</strong> CBK headquarters, Haile Selassie Avenue, Nairobi</li>
</ul>

<p>Include your case reference number from the ODPC complaint if you have already filed one.</p>
...
<p>No — revoking permissions stops future access but does not delete what was already collected. A formal data deletion request under the Data Protection Act is required for that. Include it in your formal letter to the lender (Step 3 above).</p>`,
  ...
  {
    id: 210,
    slug: 'false-crb-listing-dispute-metropol-transunion-kenya',
...
<h2>Your Legal Rights Before We Start</h2>

<p>Under the <strong>Credit Reference Bureau Regulations 2020</strong> (Legal Notice No. 97), you have specific rights regarding CRB listings:</p>

<ul>
<li>Lenders must give you <strong>30 days written notice</strong> before submitting a negative listing</li>
<li>You have the right to a <strong>free annual credit report</strong> from each CRB</li>
<li>You have the right to <strong>dispute any listing</strong> you believe is incorrect</li>
<li>The CRB must investigate disputes within <strong>30 days</strong></li>
<li>If the listing is confirmed wrong, the lender must <strong>correct it within 7 days</strong></li>
<li>You are entitled to <strong>compensation</strong> if a false listing caused you provable harm</li>
</ul>

<h2>Step 1: Get Your Full Credit Report</h2>

<p>You cannot dispute what you cannot see. Start by getting your complete credit report from both Metropol and TransUnion (CreditInfo). You are entitled to one free report per year from each.</p>
...
<h3>TransUnion (CreditInfo Kenya)</h3>
<ol>
...
<p>Before filing a dispute, clearly identify which of these applies to your situation:</p>

<table>
<thead><tr><th>Problem Type</th><th>Evidence You Need</th><th>Dispute Route</th></tr></thead>
<tbody>
...
<h2>Step 3: Contact the Lender First (Required)</h2>
...
<ul>
<li><em>I repaid this loan on [date]. Please find attached evidence of payment. This listing should be updated to "Settled" immediately.</em></li>
<li><em>The listed amount of KES [X] does not match my actual loan amount of KES [Y]. Please provide a breakdown of how this figure was calculated.</em></li>
<li><em>I did not receive the required 30-day written notice before this listing was submitted, in violation of the Credit Reference Bureau Regulations 2020.</em></li>
<li><em>I have no record of taking this loan. I believe this is an error or case of identity misuse.</em></li>
</ul>
<p><em>I request that you investigate and correct this listing within 7 working days, as required by the CRB Regulations. Please confirm receipt of this letter and the steps you are taking.</em></p>
<p><em>Your name, National ID number, registered phone number, loan account reference (if applicable)</em></p>
</blockquote>

<p>Send this via email, keep the sent copy, and note the date. If you do not receive a response within 7 business days, proceed to Step 4.</p>

<h2>Step 4A: File a Formal Dispute with Metropol CRB</h2>

<ol>
<li>Go to <strong>metropol.co.ke</strong> and log in to your account</li>
<li>Navigate to <strong>"Dispute a Listing"</strong> or <strong>"Credit Disputes"</strong></li>
<li>Select the specific listing you are disputing from your credit report</li>
<li>Select the dispute reason from the dropdown</li>
<li>Upload supporting documents:
  <ul>
  <li>Copy of your credit report highlighting the wrong entry</li>
  <li>Proof of payment (M-Pesa SMS, bank statement) if applicable</li>
  <li>Copy of your correspondence with the lender (Step 3)</li>
...
<p><strong>Metropol dispute contact:</strong> disputes@metropol.co.ke or call 0709 898 000</p>

<h2>Step 4B: File a Formal Dispute with TransUnion (CreditInfo)</h2>

<ol>
<li>Go to <strong>creditinfo.co.ke</strong> and log in</li>
...
<h2>Step 5: Escalate to the CBK if Lender or CRB Is Unresponsive</h2>

<p>If 30 days pass without resolution, escalate to the Central Bank of Kenya:</p>

<ul>
<li><strong>Online:</strong> centralbank.go.ke → Consumer Protection → File Complaint</li>
<li><strong>Email:</strong> ccpd@centralbank.go.ke</li>
<li>Include: your full name, ID number, the lender's name, the CRB case reference, and a summary of the dispute</li>
</ul>

<p>The CBK has authority to direct lenders to correct CRB listings and can impose penalties for non-compliance. CBK involvement almost always accelerates resolution.</p>
...
<ul>
<li>Loan rejection with written evidence that CRB was the reason</li>
<li>Job offer withdrawn with written reference to credit check failure</li>
<li>Higher interest rate charged due to damaged credit score</li>
<li>Business loss caused by inability to access credit</li>
</ul>
...
<table>
<thead><tr><th>Action</th><th>Expected Timeframe</th><th>Next Step If No Response</th></tr></thead>
<tbody>
...
<h3>Can I get a CRB listing removed without paying the debt?</h3>
<p>Only if the listing itself is wrong. If you genuinely owe the money and the listing is accurate, the only route to removal is settlement followed by the 60-day clearing period. You cannot dispute your way out of a legitimate debt.</p>

<h3>How long does a false CRB listing take to remove after the dispute is upheld?</h3>
